...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <x-admin.sidebar.admin-sidebar-cats-links></x-admin.sidebar.admin-sidebar-cats-links>

      @if(auth()->user()->userHasRole('Admin'))
      <x-admin.sidebar.admin-sidebar-users-links></x-admin.sidebar.admin-sidebar-users-links>
      
      <x-admin.sidebar.admin-sidebar-authorization-links></x-admin.sidebar.admin-sidebar-authorization-links>
      @endif
